...
ii  apt                                    2.0.8                              amd64        commandline package manager
...
ii  cargo                                  0.58.0-0ubuntu1~20.04.1            amd64        Rust package manager
...
ii  curl                                   7.68.0-1ubuntu2.11                 amd64        command line tool for transferring data with URL syntax
...
ii  git                                    1:2.25.1-1ubuntu3.4                amd64        fast, scalable, distributed revision control system
ii  git-man                                1:2.25.1-1ubuntu3.4                all          fast, scalable, distributed revision control system (manual pages)
...
ii  libapt-pkg6.0:amd64                    2.0.8                              amd64        package management runtime library
...
ii  libavformat58:amd64                    7:4.2.7-0ubuntu0.1                 amd64        FFmpeg library with (de)muxers for multimedia containers - runtime files
ii  libavresample4:amd64                   7:4.2.7-0ubuntu0.1                 amd64        FFmpeg compatibility library for resampling - runtime files
ii  libavutil56:amd64                      7:4.2.7-0ubuntu0.1                 amd64        FFmpeg library with functions for simplifying programming - runtime files
...
ii  libcurl3-gnutls:amd64                  7.68.0-1ubuntu2.11                 amd64        easy-to-use client-side URL transfer library (GnuTLS flavour)
ii  libcurl4:amd64                         7.68.0-1ubuntu2.11                 amd64        easy-to-use client-side URL transfer library (OpenSSL flavour)
...
ii  libdrm-dev:amd64                       2.4.107-8ubuntu1~20.04.2           amd64        Userspace interface to kernel DRM services -- development files
...
ii  libgl-dev:amd64                        1.3.2-1~ubuntu0.20.04.2            amd64        Vendor neutral GL dispatch library -- GL development files
...
ii  libglx-dev:amd64                       1.3.2-1~ubuntu0.20.04.2            amd64        Vendor neutral GL dispatch library -- GLX development files
...
ii  libpciaccess-dev:amd64                 0.16-0ubuntu1                      amd64        Generic PCI access library for X - development files
...
ii  libpostproc55:amd64                    7:4.2.7-0ubuntu0.1                 amd64        FFmpeg library for post processing - runtime files
...
ii  libstd-rust-1.57:amd64                 1.57.0+dfsg1+llvm-0ubuntu1~20.04.1 amd64        Rust standard libraries
ii  libstd-rust-dev:amd64                  1.57.0+dfsg1+llvm-0ubuntu1~20.04.1 amd64        Rust standard libraries - development files
...
ii  libswresample3:amd64                   7:4.2.7-0ubuntu0.1                 amd64        FFmpeg library for audio resampling, rematrixing etc. - runtime files
ii  libswscale5:amd64                      7:4.2.7-0ubuntu0.1                 amd64        FFmpeg library for image scaling and various conversions - runtime files
...
ii  libtiff-dev:amd64                      4.1.0+git191117-2ubuntu0.20.04.3   amd64        Tag Image File Format library (TIFF), development files
ii  libtiff5:amd64                         4.1.0+git191117-2ubuntu0.20.04.3   amd64        Tag Image File Format (TIFF) library
ii  libtiff5-dev                           4.1.0+git191117-2ubuntu0.20.04.3   amd64        Tag Image File Format library (TIFF), development files (transitional package)
ii  libtiffxx5:amd64                       4.1.0+git191117-2ubuntu0.20.04.3   amd64        Tag Image File Format (TIFF) library -- C++ interface
...
ii  libxml2:amd64                          2.9.10+dfsg-5ubuntu0.20.04.3       amd64        GNOME XML library
ii  libxml2-dev:amd64                      2.9.10+dfsg-5ubuntu0.20.04.3       amd64        Development files for the GNOME XML library
...
ii  python3.8-venv                         3.8.10-0ubuntu1~20.04.4            amd64        Interactive high-level object-oriented language (pyvenv binary, version 3.8)
...
ii  rustc                                  1.57.0+dfsg1+llvm-0ubuntu1~20.04.1 amd64        Rust systems programming language
