...
ii  cargo                                  0.62.0ubuntu0libgit2-0ubuntu0.22.04.1   amd64        Rust package manager
...
ii  gfortran-11                            11.3.0-1ubuntu1~22.04                   amd64        GNU Fortran compiler
...
ii  libdrm-dev:amd64                       2.4.110-1ubuntu1                        amd64        Userspace interface to kernel DRM services -- development files
...
ii  libgfortran-11-dev:amd64               11.3.0-1ubuntu1~22.04                   amd64        Runtime library for GNU Fortran applications (development files)
...
ii  libgl1-mesa-dev:amd64                  22.0.5-0ubuntu0.1                       amd64        transitional dummy package
...
ii  libpython3.10-dev:amd64                3.10.6-1~22.04.1                        amd64        Header files and a static library for Python (v3.10)
...
ii  libraw-dev:amd64                       0.20.2-2ubuntu2                         amd64        raw image decoder library (development files)
ii  libraw1394-11:amd64                    2.1.2-2build2                           amd64        library for direct access to IEEE 1394 bus (aka FireWire)
ii  libraw20:amd64                         0.20.2-2ubuntu2                         amd64        raw image decoder library
...
ii  libstd-rust-1.61:amd64                 1.61.0+dfsg1-1~exp1ubuntu0.22.04.1      amd64        Rust standard libraries
ii  libstd-rust-dev:amd64                  1.61.0+dfsg1-1~exp1ubuntu0.22.04.1      amd64        Rust standard libraries - development files
...
ii  libtiff5-dev:amd64                     4.3.0-6ubuntu0.3                        amd64        Tag Image File Format library (TIFF), development files (transitional package)
...
ii  libwebp-dev:amd64                      1.2.2-2                                 amd64        Lossy compression of digital photographic images
...
ii  mesa-common-dev:amd64                  22.0.5-0ubuntu0.1                       amd64        Developer documentation for Mesa
...
ii  python3.10-venv                        3.10.6-1~22.04.1                        amd64        Interactive high-level object-oriented language (pyvenv binary, version 3.10)
...
ii  rustc                                  1.61.0+dfsg1-1~exp1ubuntu0.22.04.1      amd64        Rust systems programming language
